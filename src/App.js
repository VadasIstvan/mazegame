  ...
  return (
    <div>
      ...
      <div id='content' style='display: none'>
        <h1 class='title'>Úgy néz ki megtaláltad a meglepit</h1>
        <h1 class='title'>✩₊˚.⋆☾⋆⁺₊✧</h1>
        <h1 class='title'>૮ ˶ᵔ ᵕ ᵔ˶ ა</h1>

        <p class='text'>Check out these videos:</p>

        <div class='container'>
          <div id='main-square'></div>
          <div></div>
          <div class='leaf1-left'>
            <iframe
              class='video1'
          ...
          <div class='leaf1-right'></div>
          <div class='leaf2-left'></div>
          <div class='leaf2-right'>
            <iframe
              class='video2'
              src='https://www.youtube.com/embed/VIDEO_ID_1'
              frameborder='0'
          ...
          <div class='leaf3-right'></div>
          <div class='leaf4-left'></div>
          <div class='leaf4-right'>
            <iframe
              class='video4'
              src='https://www.youtube.com/embed/VIDEO_ID_1'
              frameborder='0'
